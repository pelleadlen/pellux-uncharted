...
const ContactStatic = ({ setOpenContact, toast }) => {
  ...
  return (
    <>
      ...
      autoComplete="new-password"
        ...
        className=" shadow-[0px_2px_24px_rgba(0,0,0,0.08)] flex h-[80vh] w-full  flex-col gap-4 rounded-t-2xl bg-white p-2 text-xl text-secondary md:bottom-4 md:right-4 md:h-[580px] md:max-w-[417px] md:rounded-2xl"
      >
